...
class Election:
    def __init__(self, budget: int, num_voters: int, projects: list[ProjectEmbedding]) -> None: ...
    @property
    def budget(self) -> int: ...
    @property
    def num_voters(self) -> str: ...
    @property
...
def greedy_over_cost(
    election: Election, tie_breaking: ProjectComparator
...
def optimist_add_for_greedy(
    election: Election, p: int, tie_breaking: ProjectComparator
) -> int | None: ...
